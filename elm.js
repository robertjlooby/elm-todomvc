...
Elm.Json.Decode.Extra.make = function (_elm) {
   ...
   var maybeNull = function (decoder) {
      return $Json$Decode.oneOf(_U.list([$Json$Decode.$null($Maybe.Nothing)
   ...
   var withDefault = F2(function (fallback,decoder) {
      ...
      function (_p0) {
         return $Json$Decode.succeed(A2($Maybe.withDefault,
         fallback,
         _p0));
      });
   });
   var decodeDictFromTuples = F2(function (keyDecoder,tuples) {
      ...
      if (_p1.ctor === "[]") {
            ...
            if (_p2.ctor === "Ok") {
                  ...
                  function (_p3) {
                     return $Json$Decode.succeed(A3($Dict.insert,
                     _p2._0,
                     _p1._0._1,
                     _p3));
                  });
   ...
   var dict2 = F2(function (keyDecoder,valueDecoder) {
      ...
      function (_p4) {
         return A2(decodeDictFromTuples,keyDecoder,$Dict.toList(_p4));
      });
   });
   var set = function (decoder) {
      ...
      function (_p5) {
         return $Json$Decode.succeed($Set.fromList(_p5));
      });
   };
   var date = A2($Json$Decode.customDecoder,
   $Json$Decode.string,
   $Date.fromString);
   var apply = F2(function (f,aDecoder) {
      return A2($Json$Decode.andThen,
      f,
      function (f$) {
         return A2($Json$Decode.map,f$,aDecoder);
      });
   });
   _op["|:"] = apply;
   return _elm.Json.Decode.Extra.values = {_op: _op
                                          ,date: date
                                          ,apply: apply
                                          ,set: set
                                          ,dict2: dict2
...
Elm.Todo.make = function (_elm) {
   ...
   $Task = Elm.Task.make(_elm);
   var _op = {};
   var url = "http://serviceworker-todo.herokuapp.com/todos";
   ...
   _U.list([A2($Html.p,
           ...
           _U.list([]),
           _U.list([A2($Html.a,
           _U.list([$Html$Attributes.href("https://github.com/robertjlooby/elm-todomvc")]),
           _U.list([$Html.text("Source")]))]))]));
   var is13 = function (code) {
      return _U.eq(code,
      13) ? $Result.Ok({ctor: "_Tuple0"}) : $Result.Err("not the right key code");
   };
   var keycodeWithTargetValue = A3($Json$Decode.object2,
   F2(function (v0,v1) {
      return {ctor: "_Tuple2",_0: v0,_1: v1};
   }),
   $Html$Events.keyCode,
   $Html$Events.targetValue);
   var targetValueOnEnter = A2($Json$Decode.customDecoder,
   ...
   var InitializeState = function (a) {
      return {ctor: "InitializeState",_0: a};
   };
   ...
   var HandleDeleted = function (a) {
      return {ctor: "HandleDeleted",_0: a};
   };
   var Delete = function (a) {    return {ctor: "Delete",_0: a};};
   var HandleNew = function (a) {
      return {ctor: "HandleNew",_0: a};
   };
   var Add = {ctor: "Add"};
   var HandleUpdatedTodo = function (a) {
      return {ctor: "HandleUpdatedTodo",_0: a};
   };
   var UpdateTodo = F2(function (a,b) {
      return {ctor: "UpdateTodo",_0: a,_1: b};
   });
   var BeginEditingTodo = function (a) {
      return {ctor: "BeginEditingTodo",_0: a};
   };
      ...
      _U.list([A2($Html.div,
              ...
              _U.list([$Html$Attributes.$class("edit")
                      ...
                      function (_p6) {
                         return A2($Signal.message,
                         address,
                         A2(UpdateTodo,todo.uid,_p6));
                      })]),
              _U.list([]))]));
   });
   var taskList = F3(function (address,visibility,todos) {
      var cssVisibility = $List.isEmpty(todos) ? "hidden" : "visible";
      ...
      A2($List.map,
      todoItem(address),
      A2($List.filter,isVisible,todos)))]));
   });
   ...
   var taskEntry = F2(function (address,task) {
      ...
      _U.list([A2($Html.h1,_U.list([]),_U.list([$Html.text("todos")]))
              ...
              _U.list([$Html$Attributes.id("new-todo")
                      ...
                      $Html$Events.targetValue,
                      function (_p8) {
                         return A2($Signal.message,address,UpdateField(_p8));
                      })
   ...
   var emptyModel = {todos: _U.list([])
                    ,visibility: "All"
                    ,field: ""
                    ,focusedUid: $Maybe.Nothing};
   var newTodo = F2(function (desc,uid) {
      return {description: desc
             ,completed: false
             ,editing: false
             ,uid: uid};
   });
   var Todo = F4(function (a,b,c,d) {
      return {description: a,completed: b,editing: c,uid: d};
   });
   var todoDecoder = A2($Json$Decode$Extra._op["|:"],
   ...
   A2($Json$Decode._op[":="],"uid",$Json$Decode.string));
   var update = F2(function (action,model) {
      var _p9 = action;
      switch (_p9.ctor)
      {case "Add":
         var effect = $String.isEmpty(model.field) ? $Effects.none : $Effects.task(A2($Task.map,
           HandleNew,
           ...
           "{\"title\":\"",
           A2($Basics._op["++"],model.field,"\"}")))))));
           return {ctor: "_Tuple2"
                  ,_0: _U.update(model,{field: ""})
                  ,_1: effect};
         case "HandleNew": var _p10 = _p9._0;
           if (_p10.ctor === "Just") {
                 return {ctor: "_Tuple2"
                        ,_0: _U.update(model,
                        {todos: A2($Basics._op["++"],model.todos,_U.list([_p10._0]))})
                        ,_1: $Effects.none};
              } else {
                 return {ctor: "_Tuple2",_0: model,_1: $Effects.none};
              }
         case "UpdateField": return {ctor: "_Tuple2"
                                    ,_0: _U.update(model,{field: _p9._0})
                                    ,_1: $Effects.none};
         case "BeginEditingTodo": var _p11 = _p9._0;
           var updateTodo = function (t) {
              return _U.eq(t.uid,_p11) ? _U.update(t,{editing: true}) : t;
           };
           return {ctor: "_Tuple2"
                  ,_0: _U.update(model,
                  {todos: A2($List.map,updateTodo,model.todos)
                  ,focusedUid: $Maybe.Just(_p11)})
                  ,_1: $Effects.none};
         case "UpdateTodo": var _p13 = _p9._0;
           var _p12 = $List.head(A2($List.filter,
           function (t) {
              return _U.eq(t.uid,_p13);
           },
           model.todos));
           if (_p12.ctor === "Nothing") {
                 return {ctor: "_Tuple2",_0: model,_1: $Effects.none};
              } else {
                 if (_U.eq(_p12._0.editing,false)) return {ctor: "_Tuple2"
                                                          ,_0: model
                                                          ,_1: $Effects.none}; else {
                       var effect = $Effects.task(A2($Task.map,
                       HandleUpdatedTodo,
                       ...
                       {verb: "PATCH"
                       ,headers: _U.list([])
                       ,url: A2($Basics._op["++"],url,A2($Basics._op["++"],"/",_p13))
                       ,body: $Http.string(A2($Basics._op["++"],
                       "{\"title\":\"",
                       A2($Basics._op["++"],_p9._1,"\"}")))})))));
                       var updateTodo = function (t) {
                          return _U.eq(t.uid,_p13) ? _U.update(t,{editing: false}) : t;
                       };
                       return {ctor: "_Tuple2"
                              ,_0: _U.update(model,
                              {todos: A2($List.map,updateTodo,model.todos)})
         ...
         case "HandleUpdatedTodo": var _p14 = _p9._0;
           if (_p14.ctor === "Just") {
                 var _p15 = _p14._0;
                 var updateTodo = function (t) {
                    return _U.eq(t.uid,_p15.uid) ? _p15 : t;
                 };
                 return {ctor: "_Tuple2"
                        ,_0: _U.update(model,
                        {todos: A2($List.map,updateTodo,model.todos)})
         ...
         case "Delete": var _p17 = _p9._0;
           var handleResponse = function (response) {
              var _p16 = response.status;
              if (_p16 === 204) {
                    return $Task.succeed(_p17);
                 } else {
                    return $Task.fail($Http.RawNetworkError);
                 }
           };
           var effect = $Effects.task(A2($Task.map,
           HandleDeleted,
           ...
           {verb: "DELETE"
           ,headers: _U.list([])
           ,url: A2($Basics._op["++"],url,A2($Basics._op["++"],"/",_p17))
           ,body: $Http.empty}),
           handleResponse))));
           return {ctor: "_Tuple2",_0: model,_1: effect};
         case "HandleDeleted": var _p18 = _p9._0;
           if (_p18.ctor === "Just") {
                 return {ctor: "_Tuple2"
                        ,_0: _U.update(model,
                        {todos: A2($List.filter,
                        function (t) {
                           return !_U.eq(t.uid,_p18._0);
                        },
                        model.todos)})
                        ,_1: $Effects.none};
              } else {
         ...
         case "Check": var effect = $Effects.task(A2($Task.map,
           HandleUpdatedTodo,
           $Task.toMaybe(A2($Http.fromJson,
           todoDecoder,
           A2($Http.send,
           ...
           {verb: "PATCH"
           ,headers: _U.list([])
           ,url: A2($Basics._op["++"],url,A2($Basics._op["++"],"/",_p9._0))
           ,body: $Http.string(A2($Basics._op["++"],
           "{\"completed\":",
           A2($Basics._op["++"],
           function (_p19) {
              return $String.toLower($Basics.toString(_p19));
           }(_p9._1),
           "}")))})))));
           return {ctor: "_Tuple2",_0: model,_1: effect};
         case "ChangeVisibility": return {ctor: "_Tuple2"
                                         ,_0: _U.update(model,{visibility: _p9._0})
                                         ,_1: $Effects.none};
         default: return {ctor: "_Tuple2"
                         ,_0: _U.update(model,
                         {todos: A2($Maybe.withDefault,_U.list([]),_p9._0)})
                         ,_1: $Effects.none};}
   });
   var todosDecoder = $Json$Decode.list(todoDecoder);
   var loadInitialState = $Effects.task(A2($Task.map,
   InitializeState,
   $Task.toMaybe(A2($Http.get,todosDecoder,url))));
   ...
   function () {
      var toSelector = function (uid) {
         return A2($Basics._op["++"],"#todo-",uid);
      };
      return A2($Signal.map,
      function (_p20) {
         return toSelector(A2($Maybe.withDefault,
         "",
         function (_) {
            return _.focusedUid;
         }(_p20)));
   ...
   var Model = F4(function (a,b,c,d) {
      return {todos: a,field: b,visibility: c,focusedUid: d};
   });
   return _elm.Todo.values = {_op: _op
                             ...
                             ,BeginEditingTodo: BeginEditingTodo
                             ...
                             ,view: view
                             ,onEnter: onEnter
                             ,keycodeWithTargetValue: keycodeWithTargetValue
                             ,targetValueOnEnter: targetValueOnEnter
                             ,is13: is13
                             ,taskEntry: taskEntry
                             ,taskList: taskList
                             ,todoItem: todoItem
